 ...
 * <p>
 * Testing of PacketCapture could easily be implemented in the same class's main
 * method, but since the tester is a client and must implement the listener
 * interface, seems clearer to decouple the two.
 *
