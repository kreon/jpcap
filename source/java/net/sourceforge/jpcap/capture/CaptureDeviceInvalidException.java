...
/**
 * This exception occurs when the capture client tries to specify a capture
 * device that does not exist or if the capture device specified is illegal.
 *
...
public class CaptureDeviceInvalidException extends Exception {
	...
	private static String _rcsId = "$Id: CaptureDeviceInvalidException.java,v 1.1 2001/05/17 20:13:51 pcharles Exp $";
}
